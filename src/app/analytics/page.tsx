    ...
    <div className="min-h-screen bg-[var(--plane)] text-[var(--text-primary)]">
      ...
      <main className="overflow-x-hidden px-4 pb-20 pt-6 sm:px-6 md:ml-60 md:px-8 md:pt-10">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-2 max-w-2xl text-sm text-[var(--text-secondary)]">Analisa storefront marketplace dan lihat konteks pasar Indonesia tanpa mencampurnya dengan kalkulator profit.</p>
          <MarketOverview />
          <div className="mt-8 flex overflow-x-auto rounded-xl border border-[var(--border)] bg-[var(--surface-1)] p-1 sm:w-fit">
